...
%                                     \toctitle is used
%
\author{Ivar Ekeland\inst{1}\textsuperscript{(\Letter)} \and Roger Temam\inst{2}
...
Su, H., Sun, Y., Duan, H.: Enhanced Harris Hawk Optimized Image Segmentation Model for Unmanned Aerial Vehicle Remote Sensing Scene Segmentation. In: International Conference on Guidance, Navigation and Control, pp. 162--169. Springer Nature Singapore, Singapore (2024)
